...
Chrome invariants declared by a local overlay are never overridable here.
...
<who reads this, one or two lines>

## Voice delta from the baseline

<how this project's voice differs, if at all. e.g. "quest-board flavour: 'accept quest',
'hunter rank'. Playful, but the banned-word list still holds.">
...
<terms to avoid on top of the baseline list>

## Bilingual

<none | ES+EN. If bilingual, declare the tú/usted register and any per-language notes.>
